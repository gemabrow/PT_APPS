    ...
    (progn    ;DRAW BAND SUPPORTS
      ...
      (cond
        ...
        ((and (> dx2 96.0) (<= dx2 108.0))
          (setq nc "(5)")
          (setq bn "C:/apps/PT_CAD/rebar/bandsup_108.dwg"))
        ((and (> dx2 108.0) (<= dx2 120.0))
          (setq nc "(5)")
          (setq bn "C:/apps/PT_CAD/rebar/bandsup_120.dwg"))
        ((and (> dx2 120.0) (<= dx2 132.0))
          (setq nc "(6)")
          (setq bn "C:/apps/PT_CAD/rebar/bandsup_132.dwg"))
        ((and (> dx2 132.0) (<= dx2 144.0))
          (setq nc "(6)")
          (setq bn "C:/apps/PT_CAD/rebar/bandsup_144.dwg")))
      (if (/= bn nil)
